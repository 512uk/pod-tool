...
try {
    ...
    pfProcessor.processTiffFiles(process.env.PF_INPUT_FOLDER, process.env.PF_ARCHIVE_FOLDER);
    ...
    hazProcessor.processTiffFiles(process.env.HAZ_INPUT_FOLDER, process.env.HAZ_ARCHIVE_FOLDER);
